...
<!-- banner -->
	...
	<div class="banner-right">
					<ul id="flexiselDemo2">
						...
						<h2>Maruti</h2>
						<div class="wome">
								<a href="single.html" ><img class="img-responsive" src="images/maruti.jpeg" alt="" />
								</a>
								<div class="women simpleCart_shelfItem">
									<a href="#"><img src="images/ll.png" alt=""></a>
									<h6 ><a href="single.html">Swift Dzire</a></h6>
						...
						<h2>Honda</h2>
						<div class="wome">
								<a href="single.html" ><img class="img-responsive" src="images/honda.jpg" alt="" />
								</a>
								<div class="women simpleCart_shelfItem">
									<a href="#"><img src="images/ll.png" alt=""></a>
									<h6 ><a href="single.html">Livo</a></h6>
		...
		<div class="content-head">
					...
					<div class="col-md-6 col-m1 animated wow fadeInLeft" data-wow-delay=".1s">
						...
						<div class="col-md-6 col-2">
							<br>
							<a href="single.html"><img src="images/show.jpg" class="img-responsive" alt="">
							</a></div>
						...
						<div class="col-md-6 col-2">
							<a href="single.html"><img src="images/first.jpg" class="img-responsive" alt="">
							</a></div>
							<div class="clearfix"> </div>
						</div>
						</div>
							 ...
							 <!-- start content_slider -->
						       <div id="owl-demo" class="owl-carousel" style="background-color:white">
					                <div>
											...
											<a href="single.html"><img width="300px" height="180px"  src="images/gixer.jpg" alt="" /></a>
											<a href="single.html" class="shop-2" >Shop Now</a>

					                </div>
									<div>

											<a href="single.html"><img width="270px" height="180px" src="images/aprila.jpg" alt="" /></a>
											<a href="single.html" class="shop-2">Shop Now</a>
			...
			<!---->
				...
				<div class="content-top">
					<div class="col-md-5 col-md1 animated wow fadeInLeft" data-wow-delay=".1s">
						<div class="col-3">
							<a href="single.html"><img src="images/tesla.jpg" class="img-responsive " alt="">
							<div class="col-pic">
								<br><br>
					...
					<div class="col-md-7 col-md2 animated wow fadeInRight" data-wow-delay=".1s">
						<div class="col-sm-4 item-grid simpleCart_shelfItem">
							<div class="grid-pro">
								...
								<div class="women">
									<a href="#"><img src="images/ll.png" alt=""></a>
									<h6><a href="single.html">Sierra Denali</a></h6>
				...
				<div class="content-top">
					...
					<div class="col-md-7 col-md2 animated wow fadeInLeft" data-wow-delay=".1s">
						<div class="col-sm-4 item-grid simpleCart_shelfItem">
							<div class="grid-pro">
								...
								<div class="women">
									<a href="#"><img src="images/ll.png" alt=""></a>
									<h6><a href="single.html">Sei Giorni</a></h6>
						...
						<div class="col-sm-4 item-grid simpleCart_shelfItem">
							<div class="grid-pro">
								...
								<div class="women">
									<a href="#"><img src="images/ll.png" alt=""></a>
									<h6><a href="single.html">Street 500</a></h6>
									<p ><del>$100.00</del><em class="item_price">$70.00</em></p>
									<a href="#" data-text="Check it!" class="but-hover1 item_add">Buy Now!</a>
								</div>
							</div>
						...
						<div class="grid-pro">
								...
								<div class="women">
									<a href="#"><img src="images/ll.png" alt=""></a>
									<h6><a href="single.html">Glamour FI</a></h6>
									<p ><del>$100.00</del><em class="item_price">$70.00</em></p>
									<a href="#" data-text="Check it!" class="but-hover1 item_add">Buy Now!</a>
								</div>
							</div>
					...
					<div class="col-md-5 col-md1 animated wow fadeInRight" data-wow-delay=".1s">
						<div class="col-3">
							<a href="single.html"><img src="images/general.jpg" class="img-responsive " alt="">
							<div class="col-pic">
